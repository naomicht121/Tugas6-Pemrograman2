...
namespace P6_3_1184018
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            SqlConnection connectDB = new SqlConnection(@"Data Source=NAOMI-CHT\SQLEXPRESS;Initial Catalog=P61184018;Integrated Security=True");
            connectDB.Open();
        ...
        private void insertDB(string conn)
        {
            try
            {
                ...
                SqlConnection myConnection = new SqlConnection(@"Data Source=NAOMI-CHT\SQLEXPRESS;Initial Catalog=P61184018;Integrated Security=True");
                myConnection.Open();
